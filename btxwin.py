...
#
# matplotlib code partially from matplotlib qt embedding example
#
...
class MainWin(QtGui.QMainWindow):
     def __init__(self,bt):
         ...
         sc = MyStaticMplCanvas(self.ui, width=5, height=4, dpi=100)
         self.ui.temperaturelayout.addWidget(sc)
